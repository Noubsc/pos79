            ...
            <table class="table table-hover table-bordered table-md">
              ...
              <tbody>
                ...
                <tr v-for="payment in payments">
                  <td>{{payment.date}}</td>
                  <td>{{payment.Ref}}</td>
                  <td>{{currentUser.currency}} {{formatNumber(payment.montant)}}</td>
          ...
          <table>
            <tbody>
              <tr v-for="detail_invoice in invoice_pos.details">
                <td colspan="3"><span>{{detail_invoice.name}} <br> {{formatNumber(detail_invoice.quantity)}} {{detail_invoice.unit_sale}} x {{formatNumber(detail_invoice.total/detail_invoice.quantity,2)}}</span></td>
                <td style="text-align:right;vertical-align:bottom">{{formatNumber(detail_invoice.total)}}</td>
              </tr>


              <tr style="margin-top:10px">
                <td colspan="3" class="total">{{$t('OrderTax')}}</td>
                <td style="text-align:right;" class="total">{{invoice_pos.symbol}} {{formatNumber(invoice_pos.sale.taxe)}} ({{formatNumber(invoice_pos.sale.tax_rate)}} %)</td>
              </tr>
              ...
              <tr style="margin-top:10px">
                ...
                <td style="text-align:right;" class="total">{{invoice_pos.symbol}} {{formatNumber(invoice_pos.sale.GrandTotal)}}</td>
              </tr>

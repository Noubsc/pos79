                ...
                <table class="table table-hover table-md">
                  ...
                  <tbody>
                    <tr v-for="detail in details">
                      ...
                      <td>{{currentUser.currency}} {{formatNumber(detail.price)}}</td>
                      <td>{{currentUser.currency}} {{formatNumber(detail.DiscountNet)}}</td>
                      <td>{{currentUser.currency}} {{formatNumber1(detail.taxe,2)}}</td>
              ...
              <table class="table table-striped table-sm">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span>{{currentUser.currency}} {{formatNumber(quote.TaxNet)}} ({{formatNumber(quote.tax_rate ,2)}} %)</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="bold">{{$t('Discount')}}</td>
                    <td>{{currentUser.currency}} {{formatNumber(quote.discount)}}</td>
                  </tr>
                  <tr>
                    <td class="bold">{{$t('Shipping')}}</td>
                    <td>{{currentUser.currency}} {{formatNumber(quote.shipping)}}</td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      ...
                      >{{currentUser.currency}} {{formatNumber(quote.GrandTotal)}}</span>
                    </td>
                  </tr>
                </tbody>
              </table>

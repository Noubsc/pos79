                ...
                <table class="table table-hover table-md">
                  ...
                  <tbody>
                    <tr v-for="detail in details">
                      ...
                      <td>{{currentUser.currency}} {{formatNumber(detail.Net_cost)}}</td>
                      <td>{{formatNumber(detail.quantity)}} {{detail.unit_purchase}}</td>
                      <td>{{currentUser.currency}} {{formatNumber(detail.cost)}}</td>
                      <td>{{currentUser.currency}} {{formatNumber(detail.DiscountNet)}}</td>
                      <td>{{currentUser.currency}} {{formatNumber(detail.taxe)}}</td>
                      <td>{{currentUser.currency}} {{formatNumber(detail.total)}}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <table class="table table-striped table-sm">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span>{{currentUser.currency}} {{formatNumber(purchase.TaxNet)}} ({{formatNumber1(purchase.tax_rate,2)}} %)</span>
                    </td>
                  </tr>
                  <tr>
                    <td class="bold">{{$t('Discount')}}</td>
                    <td>{{currentUser.currency}} {{formatNumber(purchase.discount)}}</td>
                  </tr>
                  <tr>
                    <td class="bold">{{$t('Shipping')}}</td>
                    <td>{{currentUser.currency}} {{formatNumber(purchase.shipping)}}</td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      ...
                      >{{currentUser.currency}} {{formatNumber(purchase.GrandTotal)}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <span
                        class="font-weight-bold"
                      >{{currentUser.currency}} {{formatNumber(purchase.paid_amount)}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <span
                        class="font-weight-bold"
                      >{{currentUser.currency}} {{formatNumber(purchase.due)}}</span>
                    </td>
                  </tr>
                </tbody>
              </table>
...
export default {
  ...
  methods: {
    ...
    print() {
      ...
      a.document.write(
        '<link rel="stylesheet" href="/assets_setup/css/bootstrap.css" type="text/css" media="screen"><html>'
      );

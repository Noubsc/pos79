      ...
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          ...
          <div class="content">
            ...
            >{{currentUser.currency}} {{formatNumber((report_today.revenue?report_today.revenue:0))}}</p>
          </div>
        </b-card>
      </b-col>
      ...
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          ...
          <div class="content">
            ...
            <p
              class="text-primary text-24 line-height-1 mb-2"
            >{{currentUser.currency}} {{formatNumber((report_today.today_purchases?report_today.today_purchases:0))}}</p>
          </div>
        </b-card>
      </b-col>
      ...
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          ...
          <div class="content">
            ...
            <p
              class="text-primary text-24 line-height-1 mb-2"
            >{{currentUser.currency}} {{formatNumber((report_today.return_sales?report_today.return_sales:0))}}</p>
          </div>
        </b-card>
      </b-col>
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          ...
          <div class="content">
            ...
            <p
              class="text-primary text-24 line-height-1 mb-2"
            >{{currentUser.currency}} {{formatNumber((report_today.profit?report_today.profit:0))}}</p>
          </div>
        </b-card>
      </b-col>
    </b-row>
            ...
            >
              <template slot="table-row" slot-scope="props">
                <div v-if="props.column.field == 'quantity'">
                  <span>{{formatNumber(props.row.quantity)}} {{props.row.unit_product}}</span>
                </div>
                <div v-else-if="props.column.field == 'total'">
                  <span>{{currentUser.currency}} {{formatNumber(props.row.total)}}</span>
                </div>
              </template>
            </vue-good-table>
          </div>
